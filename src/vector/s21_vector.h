...
public:
  ...
  /////////////////////////////////////////////////////
  value_type at(size_type i); // доступ к указанному элементу с проверкой границ
  ...
  // max_size() const; // возвращает максимально возможное количество элементов
  void
  reserve(size_type size); // выделяет хранилище элементов размера и копирует
                           // текущие элементы массива в вновь выделенный массив
  size_type
  capacity() const; // возвращает количество элементов, которые могут храниться
  ...
  template <typename... Args> constexpr iterator emplace_back(Args &&...args);
